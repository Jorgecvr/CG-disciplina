...
export function CreateTankEnemy(size) {
// Criando Tanque
let materialTanque = setDefaultMaterial('blue'); 
...
RetanguloBase.position.set(0.0, 1.0, 12.0);
...
export function TankEnemyMove(tank) {
    var keyboard = new KeyboardState();
    keyboard.update();
    if( keyboard.pressed("W") )    tank.translateX( -0.1 );
    if( keyboard.pressed("S") )  tank.translateX( 0.1 );
