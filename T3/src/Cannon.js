...
export class Cannon {
    ...
    createCannon() {
        ...
        ptInferiorMesh.material = new THREE.MeshLambertMaterial({color: 0x3f0000});
        ...
        canoFuradoMesh.material = new THREE.MeshLambertMaterial({color: 0x845C5C});
        ...
        peComEsferaMesh.material = new THREE.MeshLambertMaterial({color: 0x845C5C});
