...
function keyboardUpdate() {
   ...
   if(keyboard.pressed("up"))       camPos.set(camPos.x + 0.1, camPos.y, camPos.z);
   if(keyboard.pressed("down"))     camPos.set(camPos.x - 0.1, camPos.y, camPos.z);
   if(keyboard.pressed("right"))    camPos.set(camPos.x, camPos.y, camPos.z + 0.1);
   if(keyboard.pressed("left"))     camPos.set(camPos.x, camPos.y, camPos.z - 0.1);
   ...
   if(keyboard.pressed("W")) camLook.set(camLook.x + 0.1, camLook.y, camLook.z);
   if(keyboard.pressed("S")) camLook.set(camLook.x - 0.1, camLook.y, camLook.z);
   if(keyboard.pressed("D")) camLook.set(camLook.x, camLook.y, camLook.z + 0.1);
   if(keyboard.pressed("A")) camLook.set(camLook.x, camLook.y, camLook.z - 0.1);
